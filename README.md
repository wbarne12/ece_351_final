...
## How to use
This project was originally created for the Digilent Basys 3 FPGA board. The board utalizes the Artix 7 FPGA from Xilinx. Bitstreams, source code, and screen shots are all in the "Submition items" folder. To program, use Vivado and upload the bitstream.   
A pre-loaded animation will play if switch 15 is high. If switch 15 is low, the bottom 5 switch will individually control the hand. 
