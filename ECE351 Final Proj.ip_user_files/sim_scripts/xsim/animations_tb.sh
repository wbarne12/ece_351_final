...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_11 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot animations_tb xil_defaultlib.animations_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim animations_tb -key {Behavioral:sim_1:Functional:animations_tb} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/var/home/david/.var/app/com.github.corna.Vivado/data/xilinx-install/2025.1/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_11)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb animations_tb.wdb xsim.dir libdpi.so)
