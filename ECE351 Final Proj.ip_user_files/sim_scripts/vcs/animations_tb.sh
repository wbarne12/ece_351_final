...
#
# Script generated by Vivado on Wed Nov 26 23:18:05 EST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : animations_tb.sh
...
#
# Usage        : animations_tb.sh
#                animations_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                animations_tb.sh [-reset_run]
#                animations_tb.sh [-reset_log]
#                animations_tb.sh [-help]
#
...
#                script (type 'animations_tb.sh -help' for more information).
#
...
# script info
echo -e "animations_tb.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./animations_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../.var/app/com.github.corna.Vivado/data/xilinx-install/2025.1/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../../.var/app/com.github.corna.Vivado/data/xilinx-install/2025.1/data/rsb/busdef" \
  "../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../.var/app/com.github.corna.Vivado/data/xilinx-install/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.animations_tb xil_defaultlib.glbl -o animations_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./animations_tb_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/var/home/david/vivado/ece_351_final/ECE351"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key animations_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc animations_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./animations_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: animations_tb.sh [-help]\n\
Usage: animations_tb.sh [-step]\n\
Usage: animations_tb.sh [-lib_map_path]\n\
Usage: animations_tb.sh [-reset_run]\n\
Usage: animations_tb.sh [-reset_log]\n\
Usage: animations_tb.sh [-keep_index]\n\
Usage: animations_tb.sh [-noclean_files]\n\n\
