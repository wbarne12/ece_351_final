...
synth_design -top animations -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef animations.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file animations_utilization_synth.rpt -pb animations_utilization_synth.pb"  } 
